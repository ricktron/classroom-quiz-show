...
- **Slice 10 (current): `Complete`.** Squash-merged via
  **[PR #21](https://github.com/ricktron/classroom-quiz-show/pull/21)** at
  ...
  hardware certification remains incomplete after OADL2-S07 Lane C stop
  (wireless keep-alive required; matrices unfinished) — **no compatibility is
  claimed**.
  Rationale in
...
- **What Slice 10 adds:** the host-private Sony Buzz! **setup boundary** on top of
  ...
  after the OADL2-S07 Lane C stop (wireless Namtai keep-alive / Gamepad-API
  gap); no compatibility is claimed. See
  [`../architecture/ADR-010-sony-buzz-profile-and-setup.md`](../architecture/ADR-010-sony-buzz-profile-and-setup.md)
  and
...
- **No physical controller has been certified.** Generic support is implemented
  ...
  and there is no supported-hardware list. OADL2-S07 (2026-08-01/02) showed
  wireless `Wbuzz` needs a host HID output keep-alive the Gamepad API cannot
  send — see
  [`../receipts/2026-08-01-oadl2-s07-sony-buzz-physical-certification.md`](../receipts/2026-08-01-oadl2-s07-sony-buzz-physical-certification.md).
...
boundary; physical certification was attempted 2026-08-01/02 (OADL2-S07) and
Lane-C stopped on wireless keep-alive / incomplete matrices — see
[`../receipts/2026-08-01-oadl2-s07-sony-buzz-physical-certification.md`](../receipts/2026-08-01-oadl2-s07-sony-buzz-physical-certification.md);
...
| **10** | **Sony Buzz!** detection, validation, a recommended profile, handset assignment, and the host setup UX. | `Complete` (PR #21, `5575be3`) — hardware-independent scope; physical certification Lane C blocked (OADL2-S07 keep-alive); no compatibility claim |
...
incomplete after the OADL2-S07 Lane C stop (wireless keep-alive required).
